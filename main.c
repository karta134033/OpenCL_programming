...
int main(int argc, char **argv)
{
   ...
   qsort(recordThread, ITER, sizeof(double), compare);
   for (int i = 3; i < 7; ++i)
   {
   ...
   printf("\n[conv opencl]:\t\t[%.3f] ms\n\n", minThread * 1000);
   // printf("outputImage[120000]: %f\n", outputImage[120000]);
   // for (int i = 0; i < 240000; ++i) if(i < 100) printf("%f ", outputImage[i]);
